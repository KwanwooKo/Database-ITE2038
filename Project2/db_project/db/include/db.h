...
int get_neighbor_index(int64_t table_id, pagenum_t leaf_page_num);
...
pagenum_t merge_internal_pages(int64_t table_id, pagenum_t leaf_page_num, pagenum_t neighbor_page_num, int neighbor_index, int64_t k_prime);
pagenum_t redistribute_internal_pages(int64_t table_id, pagenum_t leaf_page_num, pagenum_t neighbor_page_num, int neighbor_index, int k_prime_index, int64_t k_prime);
...
void print_leaf_page(int64_t table_id, pagenum_t offset);
void print_internal_page(int64_t table_id, pagenum_t offset);
void print_tree(int64_t table_id);
void print_keys(Leaf_page* lp);
